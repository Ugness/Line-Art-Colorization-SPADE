...
def get_active_img_and_save_denoise(img, path):
    mat = img.astype(np.float)
    mat = - mat + 1
    mat = mat * 255.0
    mat[mat < 0] = 0
...
def get_active_img_and_save_denoise_filter(img, path):
    mat = img.astype(np.float)
    mat[mat < 0.18] = 0
    mat = - mat + 1
    mat = mat * 255.0
...
def get_active_img_and_save_denoise_filter2(img, path):
    mat = img.astype(np.float)
    mat[mat < 0.1] = 0
    mat = - mat + 1
    mat = mat * 255.0
