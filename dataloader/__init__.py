...
from dataloader.safebooru_dataset import SafebooruDataset
...
def SafebooruDataLoader(opt):
    data_loader = SafebooruDatasetDataLoader()
...
class SafebooruDatasetDataLoader(BaseDataLoader):
    def name(self):
        return 'SafebooruDatasetDataLoader'

    def initialize(self, opt):
        BaseDataLoader.initialize(self, opt)

        self.dataset = SafebooruDataset()
