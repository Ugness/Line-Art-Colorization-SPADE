...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--hsv_aug', action='store_true', help='Use HSV Augmentation')
        ...
        parser.add_argument('--lambda_l1', type=float, default=10.0, help='weight for vgg loss')
        parser.add_argument('--lambda_l2', type=float, default=10.0, help='weight for vgg loss')
